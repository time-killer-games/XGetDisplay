...
gcc -no-pie XDisplayGetters.c ExampleUsage.c -static-libstdc++ -static-libgcc -lXinerama -lXrandr -lXext -lXrender -lX11 -lxcb -lXau -lXdmcp -ldl -static -m64 -o xgetdisplay-c-amd64 -fPIC -m64
