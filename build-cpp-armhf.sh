...
g++ -no-pie XDisplayGetters.cpp ExampleUsage.cpp -static-libstdc++ -static-libgcc -lXinerama -lXrandr -lXext -lXrender -lX11 -lxcb -lXau -lXdmcp -ldl -static -o xgetdisplay-cpp-armhf -fPIC
