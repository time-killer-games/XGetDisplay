...
gcc -no-pie XDisplayGetters.c ExampleUsage.c -static-libstdc++ -static-libgcc -lXinerama -lXrandr -lXext -lXrender -lX11 -lxcb -lXau -lXdmcp -ldl -static -o xgetdisplay-c-arm64 -fPIC
